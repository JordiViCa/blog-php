...
?>
    <main class="py-10 flex flex-row justify-arround">
            ...
            <form class="mt-10 flex flex-col" action="/validate/modify.php" method="post">
                <div class="flex flex-col mb-4">
                    <div class="flex flex-row">
                        ...
                        <input class="w-4/6 border-b border-gray-600 h-8 text-lg focus:outline-gray-500" type="text" name="rname" required id="rname" <?php echo "value='" . $actualUser['name'] . "'"; ?>>
                    </div>
                    <?php
                ...
                <div class="flex flex-col mb-4">
                    <div class="flex flex-row">
                        ...
                        <input class="w-4/6 border-b border-gray-600 h-8 text-lg focus:outline-gray-500" type="text" name="rsurname" required id="rsurname" <?php echo "value='" . $actualUser['surname'] . "'"; ?>>
                    </div>
                    <?php
                ...
                <div class="flex flex-col mb-4">
                    <div class="flex flex-row">
                        ...
                        <input class="w-4/6 border-b border-gray-600 h-8 text-lg focus:outline-gray-500" disabled type="text" name="remail" required id="remail" <?php echo "value='" . $actualUser['email'] . "'"; ?>>
                    </div>
                </div>
                <div class="flex flex-col mb-4">
                    <div class="flex flex-row">
                        <label class="w-2/6 text-right pr-4 text-lg" for="rpass">Contrasenya</label>
                        <input class="w-4/6 border-b border-gray-600 h-8 text-lg focus:outline-gray-500" type="text" name="rpass" required id="rpass">
                    </div>
                    <?php
        ...
        <div class="flex flex-wrap bg-gray-200 mx-auto w-auto px-20 py-14 rounded-md shadow-lg">
